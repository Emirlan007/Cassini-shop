...
export async function createProductFixtures(productsService: ProductsService) {
  ...
  return await productsService.createMany([
    {
      name: 'Classic Black Shawl Lapel Tuxedo',
      ...
      price: 999,
      video: 'fixtures/tuxedo-video.mp4',
      images: [
        'fixtures/tuxedo1.jpg',
        'fixtures/tuxedo2.jpg',
        'fixtures/tuxedo3.jpg',
        'fixtures/tuxedo4.jpg',
        'fixtures/tuxedo5.jpg',
        'fixtures/tuxedo6.avif',
      ],
    },
    {
    ...
    {
      name: 'Modern Slim-Fit Charcoal Tuxedo',
      colors: ['Black', 'Navy Blue', 'Charcoal Gray', 'Midnight Blue'],
      description:
    ...
    {
      name: 'Patterned Jacquard Tuxedo',
      colors: ['Black', 'Navy Blue', 'Charcoal Gray', 'Midnight Blue'],
      description:
