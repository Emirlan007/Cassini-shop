...
const ordersSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(addUserCommentToOrder.pending, (state) => {
        state.createCommentLoading = true;
      })
      .addCase(addUserCommentToOrder.fulfilled, (state) => {
        state.createCommentLoading = false;
      })
      .addCase(addUserCommentToOrder.rejected, (state) => {
        state.createCommentLoading = false;
      });
  },
  selectors: {
    ...
    selectCreateUserCommentLoading: (state) => state.createCommentLoading,
  },
});
