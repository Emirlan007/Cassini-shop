...
const AdminBannersList = () => {
  ...
  const renderHeader = () => (
    ...
    >
      <Typography variant="h5">Все баннеры</Typography>
  ...
  const renderEmptyState = () => (
    <Box p={2}>
      <Typography textAlign="center">{t("noBanners")}</Typography>
    </Box>
  );
    ...
    <Box width="100%">
      ...
      >
        ...
        >
          <TableHead>
            <TableRow>
              <TableCell sx={{ width: isSmallScreen ? "120px" : "150px" }}>
                ID
              </TableCell>
              <TableCell sx={{ width: isSmallScreen ? "150px" : "200px" }}>
                {t("forms.bannerName")}
              </TableCell>
              <TableCell sx={{ width: isSmallScreen ? "180px" : "240px" }}>
                {t("forms.description")}
              </TableCell>
              <TableCell sx={{ width: isSmallScreen ? "200px" : "250px" }}>
                {t("link")}
              </TableCell>
              <TableCell sx={{ width: "100px" }}>{t("status")}</TableCell>
              <TableCell sx={{ width: "160px" }}>{t("image")}</TableCell>
              <TableCell sx={{ width: "160px" }}>{t("actions")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {banners.map((banner) => (
